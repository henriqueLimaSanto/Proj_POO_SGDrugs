...
public class TelaVendas extends Application{
    ...
    private Label adicionarProduto;
    ...
    private TableView<Object> tblItens;
    ...
    public void start(Stage stage) throws Exception {
        ...
        tblItens = new TableView<Object>();
        tblItens.setPrefWidth(600);
        tblItens.setPrefHeight(500);
        ...
        VBox formaPagamento = new VBox(new Label("Forma de Pagamento") , new Separator(),
        new HBox(10, cbCartaoCredito), 
        new HBox(10, cbCartaoDebito), 
        new HBox(10, cbDinheiro));
        ...
        painelVenda.getChildren().addAll(geral, lblCompra, lblVenda);
    ...
    public void loadStyles() {
        ...
        String stylePainelVendas =     "-fx-background-color:white;"
